...
//				 System.out.println(paths.length);
				 JAudioUtils.essyExtractWavFeature(file2, windowList, resultList);//这里写死了配置文件的本地路径。。无奈啊。。
				 file2.delete();
				 //输出特征为bytes
				 outputStream2.writeInt(windowList.size());
...
//					 System.out.print(windowList.get(i)[0]+","+windowList.get(i)[1]+":");
